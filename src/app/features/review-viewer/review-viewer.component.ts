...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, DomainBadgeComponent, MarkdownRendererComponent],
            ...
            <section class="refine-panel">
              ...
              <div class="refine-actions">
                <button
                  ...
                  [disabled]="!refineDraft.trim() || refining() || !hasApiKey()"
                >
                  @if (refining()) {
              ...
              @if (!hasApiKey()) {
                <p class="refine-warn">Set your API key in Settings to enable refinement.</p>
              }
              @if (refineError()) {
...
export class ReviewViewerComponent {
  ...
  async onRefine(question: Question): Promise<void> {
    ...
    if (!apiKey) {
      this.refineError.set('Set your API key in Settings before refining.');
      return;
    }
